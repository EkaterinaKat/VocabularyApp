...
public class ConnectionWithDB {
    ...
    static String getTableNameByListName(String listName) {
        String tableName = "";
    ...
    static List<String> getCatalogue() throws SQLException {
    ...
    static List<Pair> getListOfPairs(String listName) {
    ...
    static void addWord(String listName, String word, String translation) {
        String tableName = getTableNameByListName(listName);
    ...
    static void addList(String listName) {
    ...
    static void changeLevel(Pair pair, int newLevel) {
    ...
    static List<Pair> getPairsForSearch(String inputString) {
