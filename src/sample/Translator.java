...
public class Translator {
    ...
    static String translateToEng(String inString){
    ...
    static boolean isStingInEnglish(String inString){
        char[] inChars = inString.toCharArray();
    ...
    static String translateToRus(String inString){
        char[] inChars = inString.toCharArray();
        for(int i = 0; i<inChars.length; i++){
    ...
    static boolean isStingInRussian(String inString){
        char[] inChars = inString.toCharArray();
        for(char inChar: inChars){
